...
import {
  Globe, Car, User, CalendarCheck,
  LayoutGrid, Heart, Sparkles, Route, MapPin, Briefcase, X, Home
...
const tabs: NavTab[] = [
  ...
  { label: "Брони", icon: CalendarCheck, to: "/profile/bookings" },
...
const panelLinks = [
  ...
  { label: "Начать", icon: Sparkles, to: "/start", desc: "Подбор по настроению" },
